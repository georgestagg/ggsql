...
[![](./screenshots/positron-ggsql-integration.png)](./screenshots/positron-ggsql-integration.png)

## Installation

First, install ggsql on your system using the [installation instructions](../installation.llms.md).
...
[![](./screenshots/positron-extensions-pane.png)](./screenshots/positron-extensions-pane.png)
...
[![](./screenshots/positron-console-session.png)](./screenshots/positron-console-session.png)
...
[![](./screenshots/positron-console-pane.png)](./screenshots/positron-console-pane.png)

Executing ggsql statements containing [`VISUALISE`](../../syntax/clause/visualise.llms.md) will render the resulting visualization in the Plots pane.

[![](./screenshots/positron-plots-pane.png)](./screenshots/positron-plots-pane.png)
...
[![](./screenshots/positron-cells.png)](./screenshots/positron-cells.png)

## Using ggsql with `.sql` files
...
[![](./screenshots/positron-console-connections.png)](./screenshots/positron-console-connections.png)
...
[![](./screenshots/positron-connections.png)](./screenshots/positron-connections.png)
