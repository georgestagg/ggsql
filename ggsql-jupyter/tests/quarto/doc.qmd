...
### Global Constant in VISUALISE

Set a constant color for all layers using the VISUALISE clause:
...
SCALE x SETTING type => 'date'
LABEL title => 'Time Series with Global Constant Color'
```
...
DRAW point MAPPING 120 AS y, 'Threshold' AS color SETTING size => 20
SCALE x SETTING type => 'date'
...
SELECT x, y FROM 'data.csv'
VISUALISE x, y
DRAW point MAPPING 'blue' AS color, 100 AS size
DRAW point MAPPING 'red' AS color, 50 AS size FILTER y > 50
